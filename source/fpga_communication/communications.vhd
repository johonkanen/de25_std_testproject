...
architecture rtl of fpga_communications is
    ...
    -- initialised so number_of_clocks_per_bit is never 0 during the first
    -- clock edge (a 0 makes uart_rx compute clocks_per_bit-1 = -1); the
    -- test_uart process overwrites both with g_clock_divider every edge.
    signal uart_rx_data_in  : uart_rx_data_input_group := init_uart_rx;
